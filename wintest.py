...
def landmark_to_servo_angle(hand_landmarks):
    ...
    wrist_x = clamp(WRIST.x, wrist_x_min, wrist_x_max)
    servo_angle[0] = map_range(wrist_x, wrist_x_min, wrist_x_max, x_max, x_min)
    ...
    servo_angle[2] = 180-map_range(palm_size, plam_size_min, plam_size_max, z_max, z_min)
